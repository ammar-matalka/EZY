            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center">
                    <a href="/" class="flex items-center">
                        <img src="{{ asset('images/logo.png') }}" alt="EzySkills - Empower Your Skills" class="h-14 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#" class="text-gray-700 hover:text-orange-500 transition">Courses</a>
                    <a href="#" class="text-gray-700 hover:text-orange-500 transition">FAQ</a>
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('login') }}" class="px-6 py-2 border-2 border-orange-500 text-orange-500 rounded-lg hover:bg-orange-50 transition font-medium">
                        Log In
                    </a>
                    <a href="{{ route('register') }}" class="px-6 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition font-medium">
                        Create Account
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="text-gray-300 hover:text-white transition">Your FAQ's</a></li>
