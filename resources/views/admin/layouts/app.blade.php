        ...
        <aside class="w-64 bg-primary text-white flex-shrink-0 hidden md:block overflow-y-auto">
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    ...
                    <!-- Courses -->
                    <a href="{{ route('admin.courses.index') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.courses.*') ? 'bg-orange text-white' : 'text-gray-300 hover:bg-primary-light' }} transition">
                        <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
